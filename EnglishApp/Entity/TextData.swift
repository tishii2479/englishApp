...
//  EnglishApp
//
//  Created by Tatsuya Ishii on 2020/07/23.
...
class TextData {
    ...
    この利用規約（以下，「本規約」といいます。）は，英読（以下，「当アプリ」といいます。）がこのスマートフォンアプリケーション上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
    ...
    第4条（利用料金および支払方法）
    ユーザーは，本サービスの有料部分の対価として，当アプリが別途定め，本アプリケーションに表示する利用料金を，当アプリが指定する方法により支払うものとします。
    ...
    第10条（有料コンテンツ）
    1　本サービス内の一部については、対価を支払うことにより有料コンテンツを購入することができます。有料コンテンツの金額、決済方法その他の事項は、別途当アプリが定め、本サービスまたは当アプリウェブサイトに表示します。
    2　当アプリは、本サービスにおいて無償または有料とされているコンテンツについて、当アプリの裁量でその価格を変更することがあります。
    3　利用者が有料コンテンツの対価の支払いを遅滞した場合、利用者は、年14.6％の割合による遅延損害金を当アプリに対して支払うものとします。
    4　有料コンテンツは、利用者本人の登録情報に対してのみ使用が許諾されます。

    第11条（コインの取り扱い）
    1　当アプリは、本サービスにおいて利用者がコインを購入した場合、当アプリがキャンペーンを実施する場合その他の場合に、当アプリの定める方法により、利用者にコインを付与します。コインの購入単位、価格、有効期間、その他のコインの付与条件は、当アプリが定め、本サービス上に表示します。
    2　〇〇コインの有効期間は、コインが付与された日から6か月とします。
    3　当アプリは、利用者が取得したコインについて、法令上必要な場合を除き、一切払い戻しを行いません。法令に基づきコインを払い戻す場合の払戻方法および条件は、別途当アプリが定める方法で掲示するものとします。
    ...
    第13条（免責）
    1　当アプリは、本サービスの内容変更、中断、終了によって生じたいかなる損害についても、一切責任を負いません。
    2　当アプリは、利用者の本サービスの利用環境について一切関与せず、また一切の責任を負いません。
    3　当アプリは、本サービスが利用者の特定の目的に適合すること、期待する機能・商品的価値・正確性・有用性を有すること、利用者による本サービスの利用が利用者に適用のある法令または業界団体の内部規則等に適合すること、および不具合が生じないことについて、何ら保証するものではありません。
    4　当アプリは、本サービスが全ての情報端末に対応していることを保証するものではなく、本サービスの利用に供する情報端末のＯＳのバージョンアップ等に伴い、本サービスの動作に不具合が生じる可能性があることにつき、利用者はあらかじめ了承するものとします。当アプリは、かかる不具合が生じた場合に当アプリが行うプログラムの修正等により、当該不具合が解消されることを保証するものではありません。
    5　利用者は、AppStore、GooglePlay等のサービスストアの利用規約および運用方針の変更等に伴い、本サービスの一部又は全部の利用が制限される可能性があることをあらかじめ了承するものとします。
    6　当アプリは、本サービスを利用したことにより直接的または間接的に利用者に発生した損害について、一切賠償責任を負いません。
    7　当アプリは、利用者その他の第三者に発生した機会逸失、業務の中断その他いかなる損害（間接損害や逸失利益を含みます）に対して、当アプリが係る損害の可能性を事前に通知されていたとしても、一切の責任を負いません。
    8　第１項乃至前項の規定は、当アプリに故意または重過失が存する場合又は契約書が消費者契約法上の消費者に該当する場合には適用しません。
    9　前項が適用される場合であっても、当アプリは、過失（重過失を除きます。）による行為によって利用者に生じた損害のうち、特別な事情から生じた損害については、一切賠償する責任を負わないものとします。
    10　本サービスの利用に関し当アプリが損害賠償責任を負う場合、当該損害が発生した月に利用者から受領した利用額を限度として賠償責任を負うものとします。
    11　利用者と他の利用者との間の紛争及びトラブルについて、当アプリは一切責任を負わないものとします。利用者と他の利用者でトラブルになった場合でも、両者同士の責任で解決するものとし、当アプリには一切の請求をしないものとします。
    12　利用者は、本サービスの利用に関連し、他の利用者に損害を与えた場合または第三者との間に紛争を生じた場合、自己の費用と責任において、かかる損害を賠償またはかかる紛争を解決するものとし、当アプリには一切の迷惑や損害を与えないものとします。
    13　利用者の行為により、第三者から当アプリが損害賠償等の請求をされた場合には、利用者の費用（弁護士費用）と責任で、これを解決するものとします。当アプリが、当該第三者に対して、損害賠償金を支払った場合には、利用者は、当アプリに対して当該損害賠償金を含む一切の費用（弁護士費用及び逸失利益を含む）を支払うものとします。
    14　利用者が本サービスの利用に関連して当アプリに損害を与えた場合、利用者の費用と責任において当アプリに対して損害を賠償（訴訟費用及び弁護士費用を含む）するものとします。

    第14条（サービスの終了）
    １　当社は、利用者への適宜の方法で通知することにより、本サービスを終了することができるものとします。
    ２　利用者は、本サービスが終了した場合、有料コンテンツを利用する権利一切を失い、以後、当該有料コンテンツを利用できなくなることをあらかじめ異議なく同意するものとします。
    ３　当社は、本サービスが原因を問わず終了した場合、これに起因して生じた利用者または第三者が被った損害について、一切責任を負わないものとします。
    ...
    英読（以下，「当アプリ」といいます。）は，本アプリケーション上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
    ...
    利用目的の変更を行った場合には，変更後の目的について，当アプリ所定の方法により，ユーザーに通知し，または本アプリケーション上に公表するものとします。
    ...
    当アプリが別途定める場合を除いて，変更後のプライバシーポリシーは，本アプリケーションに掲載したときから効力を生じるものとします。

    第10条（お問い合わせ窓口）
    本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。

    Eメールアドレス：　eidoku1234@gmail.com

    """
    
    static let contact: String =
    """
    当アプリについてのお問い合わせはお手数おかけしますが、以下のメールアドレスにお願いいたします。

    Eメールアドレス：　eidoku1234@gmail.com
    """
    
    static let actOnSettlement: String =
    """
    ・支払い可能金額等
    コイン
    上限はございません。
    ...
    ・有効期間
    ご購入いただいたコインの有効期限はありません。
    
    ・相談窓口
    Eメールアドレス：　eidoku1234@gmail.com

    ・使用場所
    iOS向けアプリ「英読」内でご利用いただけます。

    ・ご利用上の注意
    商品の特性上、原則としてご購入後のキャンセル・返金に応じることはできません。

    ・利用規約
    設定画面 > 利用規約よりご覧いただけます。
    """
    
    static let commericalTransaction: String =
    """
    ・お問い合わせ先
    Eメールアドレス：　eidoku1234@gmail.com

    ・商品代金
    コンテンツ等の価格は購入手続き画面の際に画面に表示されます。

    ・商品代金以外の必要料金
    本アプリ及びコンテンツ等のダウンロード、インストールに伴う通信費

    ・お支払い方法
    購入手続きの際に画面に表示されお客様が選択された決済方法によってお支払いいただきます。
    
    ・引き渡し時期
    購入手続き完了後、即時に利用可能になります。
